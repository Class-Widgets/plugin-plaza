...
示例用法:
  ...
  %(prog)s --manifest-dir /path/to/manifest --output /path/to/index.json
    ...
    parser.add_argument(
        ...
        nargs='?',
        default='.',
        help='Plugin manifest directory (default: current directory)'
    )
    
    parser.add_argument(
        '-o', '--output',
        help='Output index file path (default: manifest_dir/index.json)'
    )
    
    parser.add_argument(
        '--version',
        action='version',
        version='Plugin Index Generator 1.0.0'
    )
